...
while True:
    ...
    text_day_of_week = font.render(day_of_week, True, font_color)
    ...
    text_day_month_year = font.render(day_month_year, True, font_color)
    ...
    screen.blit(text_time, ((screen_size[0] - width_time) // 2, (screen_size[1] - height_time) // 2))
    screen.blit(text_hundredths, ((screen_size[0] - width_time) // 2 + width_time, (screen_size[1] - height_time) // 2))
    screen.blit(text_am_pm, ((screen_size[0] - width_time) // 2 + width_time + width_hundredths, (screen_size[1] - height_time) // 2))
    ...
    # draw the day month and year at the bottom left
    
    screen.blit(text_day_month_year, (0, screen_size[1] - height_time))
    ...
    for i in range(9):
        ...
        draw_at =                 (
                    ...
                    settings['fontSize'] // 3, settings['fontSize'] // 3
                )
